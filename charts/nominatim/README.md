...
| `externalDatabase.existingSecretUrl`          | Name of existing secret to use to set full PostgreSQL Uniform Resource Locator (overrides `externalDatabase.*`)                                                                                                                                                   | `nil`                         |
| `externalDatabase.existingSecretUrlKey`       | Name of key in existing secret to use to set full PostgreSQL Uniform Resource Locator. Only used when `externalDatabase.existingSecretUrl` is set.                                                                                                                | POSTGRESQL_URL                |
